...
|Metrics                    | Definition  |
| -------------             |-------------| 
| Number of cookies         | Number of unique cookies to view the course overview page (<span style="color:red">*dmin=3000*</span>)|
| Number of user-ids        | Number of users who enroll in the free trial. (<span style="color:red">*dmin=50*</span>)|
| Number of clicks          | Number of unique cookies to click the "Start free trial" button (which happens before the free trial screener is trigger). (<span style="color:red">*dmin=240*</span>)|
| Click-through-probability | Number of unique cookies to click the "Start free trial" button divided by number of unique cookies to view the course overview page. (<span style="color:red">*dmin=0.01*</span>)|
| Gross conversion          | Number of user-ids to complete checkout and enroll in the free trial divided by number of unique cookies to click the "Start free trial" button. (<span style="color:red">*dmin=0.01*</span>)|
|Retention                  | Number of user-ids to remain enrolled past the 14-day boundary (and thus make at least one payment) divided by number of user-ids to complete checkout. (<span style="color:red">*dmin=0.01*</span>) |
| Net conversion            | Number of user-ids to remain enrolled past the 14-day boundary (and thus make at least one payment) divided by the number of unique cookies to click the "Start free trial" button. (<span style="color:red">*dmin=0.0075*</span>)|
